...
protected:
	 ...
	 */
	ListNode * Create_List_Item(parent * data){
		ListNode * tmp;
...
public:
	 ...
	 */
	inline void Add_List_Item_at_End(parent * item){
	 ...
	 */
	virtual void Add_List_Item(parent * item, int pos = 0);
